export default function Page4(){
    return (
        <div className="bg-[url('/src/assets/library.jpg')] bg-center bg-cover bg-no-repeat w-full h-full relative">
            <div className="w-full h-full bg-[rgba(0,0,0,0.4)] flex flex-row">
                <div className="mt-30 text-white w-6/10 ml-30">
                    ...
                    <div className="statistics w-full h-4/10 border border-yellow-500 border-4"></div>
                </div>
            </div>
        </div>
    )
